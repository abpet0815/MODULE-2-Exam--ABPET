//Abdul Adzis L. Abpet (EMC)
//Module 2 Summative Assessment - Computer Graphics Programming
...
function createRoom(){
	...
	const floor = new THREE.Mesh( 
		...
		new THREE.MeshLambertMaterial( { color: 0xc48c6f } ) 
	);
...
function createCabinetArea(){
	...
	const carpet = new THREE.Mesh(
		...
		new THREE.MeshLambertMaterial({color:0x795c34})
	);
...
function createCouchSides(){
	...
	const couchSide = new THREE.Mesh(
		...
		new THREE.MeshLambertMaterial({ color: 0x192841})
	);
